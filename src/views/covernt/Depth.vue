<template>
  <div class="views-depth">
    <el-card>
      ...
      <div class="clear"></div>
      <muliti-line-chart class="chart" title="浏览深度的转化分析" :data="chartData" />
    </el-card>
    <el-card class="table-warp">
      ...
      <div class="clear">
        ...
        <el-button v-popover:colums-popover trigger="click" class="fr custom-columns" size="mini">
          自定义列
      ...
      <el-table v-loading="loading" class="table" :data="tableData" @sort-change="sortChangeHandler">
        ...
        <el-table-column label="浏览深度" prop="intervalRange"></el-table-column>
        <el-table-column
          label="浏览量"
          sortable="custom"
      ...
      <div class="pager">
        <el-pagination
          ...
          :page-size.sync="pageConfig.limit"
...
const DEPTH_LIST_BASIC_COLUMNS_KEY = "depthListBasicColumnsKey";
const DEPTH_LIST_CONVERNSION_COLUMNS_KEY = "depthListConversionColumnsKey";
...
export default {
  ...
  watch: {
    "tableColumns.basicChecked"(value) {
      save(DEPTH_LIST_BASIC_COLUMNS_KEY, value);
    },
    "tableColumns.conversionChecked"(value) {
      save(DEPTH_LIST_CONVERNSION_COLUMNS_KEY, value);
    }
  },
  created() {
    this.tableColumns.basicChecked =
      read(DEPTH_LIST_BASIC_COLUMNS_KEY) || this.tableColumns.basicChecked;
    this.tableColumns.conversionChecked =
      read(DEPTH_LIST_CONVERNSION_COLUMNS_KEY) ||
      this.tableColumns.conversionChecked;
    this.getPageData();
  }
};
